...
npm install --save-dev webpack webpack-cli webpack-dev-server  #Установка Webpack и Webpack CLI
npm install --save-dev concurrently #Запуск client-server
npm install --svae-dev nodemon #Отслеживание изменений
